...
def select_in_superstamp_approx(ra, dec):
    """
    select positions which are approximately inside the superstamp

    ra & dec are numpy arrays, both in degrees
    """
...
if __name__ == '__main__':
    ...
    mask = select_in_superstamp_approx(ra, dec)
